    ...
    <div className="dashboard-container">
      ...
      <div className="dashboard-grid">
        <div className="dashboard-card">
          ...
          <p className="description">Usuarios actualmente activos en el sistema</p>
        </div>
        <div className="dashboard-card">
          <h3>Última Actividad</h3>
          <div className="number-display">{stats.lastActivity}</div>
          <p className="description">Hora de la última actividad registrada</p>
        </div>
        <div className="dashboard-card">
      ...
      <div className="settings-section">
        ...
        <div className="dashboard-grid">
          <button className="update-button" onClick={() => navigate("/monitor/graphs/usageCharts")}>
            Ver Gráficos de Uso
          </button>
          <button className="update-button" onClick={() => navigate("/monitor/storage/storageUsage")}>
